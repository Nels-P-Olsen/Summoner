...
namespace Summoner.Notifications
{
    ...
    {
        public MetroNotification(MetroNotificationConfiguration configuration)
        {
        ...
        public MetroNotificationConfiguration Configuration
        {
            get;
            private set;
        }
        ...
        {
            SummonerService.LogError("Win8 Toast Notification Failed: {0}", args.ErrorCode.Message);
        }
    }
}
