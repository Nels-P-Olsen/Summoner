...
namespace Summoner.Clients
{
    public class ImageManager
    {
        ...
        private void HandleRequest(QueuedRequest queuedRequest)
        {
            ...
            switch (Client.Configuration.Authenticator)
            {
                case "network":
                    request.Credentials =
                        Client.Configuration.IntegratedSecurity
                        ? CredentialCache.DefaultNetworkCredentials
                        : new NetworkCredential(Client.Configuration.Username, Client.Configuration.Password);
                    break;
                case "basic":
